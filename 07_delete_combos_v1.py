""" Component 5 -- Delete Combos (version 1)
This code is taking the recyclable function from search combos
and using it to find and delete items.
Combos are not actually delete in this code
instead function is being checked so that it works
Written by Katelyn
